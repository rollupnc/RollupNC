...
class Ens extends AbstractWeb3Module {
  constructor(provider, options, ensModuleFactory, contractModuleFactory, accounts, abiCoder, utils, formatters$$1, net, nodeNet) {
...
class Registry extends AbstractContract {
  constructor(provider, contractModuleFactory, accounts, abiCoder, utils, formatters$$1, options, net) {
    super(provider, contractModuleFactory, accounts, abiCoder, utils, formatters$$1, REGISTRY_ABI, '', options);
    this.net = net;
...
class EnsModuleFactory {
  createENS(provider, contractModuleFactory, accounts, abiCoder, utils, formatters$$1, net, ensModuleOptions, nodeNet) {
    return new Ens(provider, ensModuleOptions, this, contractModuleFactory, accounts, abiCoder, utils, formatters$$1, net, nodeNet);
  }
  createRegistry(provider, contractModuleFactory, accounts, abiCoder, utils, formatters$$1, options, net) {
    return new Registry(provider, contractModuleFactory, accounts, abiCoder, utils, formatters$$1, options, net);
  }
}
